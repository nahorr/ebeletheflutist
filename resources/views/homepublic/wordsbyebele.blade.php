								...
								<div class="col-md-3">
									...
									<div class="img-box-6-item">
										...
										<div class="img-box-6-img">
											<!-- Image -->
											<a href="{{url('/showwordsbyebele/'.$word->id)}}" ><img src="{{asset('/words/images/'.$word->word_image )}}" alt="" class="img-responsive" /></a>
										</div>	
										<!-- Image Box #6 Content -->
										<div class="img-box-6-content">
											<h4><a href="{{url('/showwordsbyebele/'.$word->id)}}">{{$word->word_title}}</a></h4>
