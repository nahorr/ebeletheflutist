						...
						<div class="col-md-3 col-sm-6">
							...
							<div class="foot-item">
								...
								<div class="foot-item-content address">
									<!-- Heading -->
									<h6 class="bold"><i class="fa fa-home"></i>&nbsp;&nbsp;Nahorr Analytics Ltd</h6>
									<!-- Paragraph -->
									<p class="add">
									   55 Westlynn Spur, Claresholm<br />
									   Alberta - T0L0T0.</p>
									<p class="tel"> <i class="fa fa-phone"></i> Tel : + (403) - 402 2387<br />
									<i class="fa fa-envelope"></i>  Mail : <a href="#">nnamdi@nahorr.com</a><br />
			...
			<footer>
				...
				<div class="container">
					<!-- Footer Content -->
						<!-- Paragraph -->
						<p class="pull-left">Copyright &copy; 2018 - <a href="https://www.nahorr.com/">Nahorr Analytics</a></p>
