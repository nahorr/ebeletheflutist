					...
					<div class="blog-two">
						<div class="row">
							...
							<div class="col-md-7">
								...
								<div class="blog-two-item">
									...
									<div class="blog-two-content">
										<!-- Heading -->
										<h3><a href="#">{{$tip->tip_title}}</a></h3>
										<!-- Blog meta -->
										<div class="blog-meta">
											<!-- Date -->
											<a href="#"><i class="fa fa-calendar"></i> {{$tip->created_at}}</a> &nbsp; 
											<!-- Author -->
										...
										<div id="bs-carousel-1" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover" data-wrap="true">
											...
											<div class="carousel-inner">
												...
												<div class="item active">
													<!-- Image -->
													<img src="{{asset('/tips/images/'.$tip->tip_image )}}" alt="">
												</div>
							...
							<!-- Categories Widget -->
									<div class="s-widget">
										<!-- Heading -->
										<h5><i class="fa fa-folder color"></i>&nbsp; All #MusicFluteTrainingTipsByEbele</h5>
										<!-- Widgets Content -->
										<div class="widget-content categories">

											<ul class="list-6">
												@foreach($latest_tips as $latest_tip)
													<li><a href="{{ url('/musicflutetrainingtipsbyebeletip/'.$latest_tip->id)}}">{{$latest_tip->tip_title}} <span class="color">({{$latest_tip->created_at}})</span></a></li>
												@endforeach
