...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Nahorr Analytics</title>
    ...
    <body class="no-skin">
        ...
        <![endif]-->
        <script src="{{asset('ace/assets/js/jquery-ui.custom.min.js')}}"></script>
        <script src="{{asset('ace/assets/js/jquery.ui.touch-punch.min.js')}}"></script>
        <script src="{{asset('ace/assets/js/jquery.easypiechart.min.js')}}"></script>
        <script src="{{asset('ace/assets/js/jquery.sparkline.index.min.js')}}"></script>
        <script src="{{asset('ace/assets/js/jquery.flot.min.js')}}"></script>
        <script src="{{asset('ace/assets/js/jquery.flot.pie.min.js')}}"></script>
