    ...
    <div class="col-sm-6">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">Edit tip: {{$tip->tip_title}}</h4>
                
            </div>

            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-group" action="{{ url('/admin/tips/postedittip', [$tip->id]) }}" method="POST" enctype="multipart/form-data">
	                    ...
	                    <div class="widget-body">
	                        <div class="widget-main">
	                            ...
	                            <div class="row">
	                                <div class="col-xs-8 col-sm-11">
	                                    <div class="input-group">
	                                        <input class="form-control" id="tip_title" type="text" name="tip_title" value="{{$tip->tip_title}}" />
	                            ...
	                            <div class="form-group">
	                                <label><strong>Please upload same picture again or upload a new picture for this tip</strong> </label>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var content = {!! json_encode($tip->tip_body) !!};
